...
public class DownloadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcv1 = view.findViewById(R.id.recylerView1);
        rcv1.setHasFixedSize(true);
        if (!(musicFiles.size()<1)){
            music1= new MusicAdpter(getContext(),musicFiles);
            rcv1.setAdapter(music1);
            rcv1.setLayoutManager(new LinearLayoutManager(getContext(),RecyclerView.VERTICAL,false));
        }
        return view;
    }
}